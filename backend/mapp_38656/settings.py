"""
Django settings for mapp_38656 project.
...
WSGI_APPLICATION = 'mapp_38656.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mapp_38656 API",
    "DESCRIPTION": "API documentation for mapp_38656 App",
    "VERSION": "v1",
}
